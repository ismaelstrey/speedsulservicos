...
export default function RootLayout({
  ...
  return (
    <html lang="pt-br">
      <script async src="https://ackee.speedsul.pro/tracker.js" data-ackee-server="https://ackee.speedsul.pro" data-ackee-domain-id="7420864f-16d3-44ac-99d7-582cd4348345"></script>
